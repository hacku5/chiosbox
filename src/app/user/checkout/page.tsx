...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    if (tourRunning) {
      ...
      setInvoices(pending as unknown as Invoice[]);
  ...
  const handlePay = async () => {
    ...
    // Tour mode: mock payment
    if (tourRunning) {
      await new Promise((r) => setTimeout(r, 1500));
      setQrCode("QR-CBX-MOCK-001");
      setStep("success");
  ...
  return (
    <div className="p-6 lg:p-8">
      <div className="max-w-lg mx-auto" data-tour="checkout">
